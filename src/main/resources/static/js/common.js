...
function selectDeptTree() {
    var options = {
        title: '部门选择',
        width: "380",
        url: "/Basic/Dept/selectDeptTree/" + ($("#fPid").val()?$("#fPid").val():"b6030e20-2784-11ea-a35c-00505689454c"),
        callBack: doSubmit
    };
...
function selectMenuTree() {
    var options = {
        title: '部门选择',
        width: "380",
        url: "/Basic/Menu/selectMenuTree/" + ($("#fPid").val()!=0?$("#fPid").val():"1"),
        callBack: doSubmit
    };
    $.modal.openOptions(options);
}
