...
@RequestMapping("process/LCLZ")
@Controller
public class LCLZController {
    ...
    public String add(ModelMap mmap) {
        ...
        mmap.put("user", user);
        return "process/LCLZ/add";
    }

    @Log(title = "新增报修单", businessType = BusinessType.INSERT)
...
//        System.out.println(ids);
    ...
    public String receiveBMain(@PathVariable("id") String fid, ModelMap modelMap){
        ...
        mainResult.setDetls(JSON.toJSONString(detls));
        modelMap.addAttribute("mainResult",mainResult);
        return "process/LCLZ/receiveBMain";
    }

    @RequestMapping(value = {"/ReceiveTo"})
    public String ReceiveTo(){
        return "process/LCLZ/Receive";
    }
