package com.jinfei.jfmm.framework.aspectj;

import com.jinfei.jfmm.common.annotation.Log;
import com.jinfei.jfmm.common.enums.BusinessStatus;
import com.jinfei.jfmm.common.utils.StringUtils;
import com.jinfei.jfmm.common.utils.shiroUtil;
import com.jinfei.jfmm.framework.manager.AsyncManager;
import com.jinfei.jfmm.framework.manager.factory.AsyncFactory;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.jinfei.jfmm.common.annotation.Log)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e)
    {
        try
        {
            ...
            // 获取当前的用户
            User currentUser = shiroUtil.getSysUser();
